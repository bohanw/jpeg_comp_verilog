...
# DVE full session
# Saved on Tue Feb 28 15:04:22 2017
# Designs open: 1
#   Sim: dve
...
#<Session mode="Full" path="/afs/umich.edu/class/eecs627/w17/group5/PROJECT/jpeg_verilog/verilog/dct_hierarchical/dct_stage/session.inter.vpd.tcl3.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{3203 125} {5118 1115}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 376]
catch { set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier] }
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 376
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 375} {height 465} {dock_state left} {dock_on_new_line true} {child_hier_colhier 293} {child_hier_coltype 113} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 381} {height 465} {dock_state left} {dock_on_new_line true} {child_data_colvariable 176} {child_data_colvalue 83} {child_data_coltype 135} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 427]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1917
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 427
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1915} {height 426} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_11" { dut.d0.sum_scaled }
gui_set_radix -radix {decimal} -signals {Sim:dut.d0.sum_scaled}
gui_set_radix -radix {twosComplement} -signals {Sim:dut.d0.sum_scaled}
...
gui_sg_addsignal -group "$_session_group_12" { dut.d0.clk dut.d0.wr_en dut.d0.start dut.d0.cnt dut.d0.n_cnt dut.d0.done dut.d0.next_done dut.d0.sum {dut.d0.sum_scaled[7]} {dut.d0.sum_scaled[6]} {dut.d0.sum_scaled[5]} {dut.d0.sum_scaled[4]} {dut.d0.sum_scaled[3]} {dut.d0.sum_scaled[2]} {dut.d0.sum_scaled[1]} {dut.d0.sum_scaled[0]} dut.d0.next_data_out dut.d0.data_out dut.d0.data_in dut.d0.sum_scaled }
gui_set_radix -radix {decimal} -signals {Sim:dut.d0.cnt}
gui_set_radix -radix {twosComplement} -signals {Sim:dut.d0.cnt}
gui_set_radix -radix {decimal} -signals {Sim:dut.d0.n_cnt}
gui_set_radix -radix {twosComplement} -signals {Sim:dut.d0.n_cnt}
...
catch {gui_list_select -id ${Hier.1} {dut.d0}}
...
catch { gui_list_select -id ${Data.1} {dut.d0.done dut.d0.start }}
gui_view_scroll -id ${Data.1} -vertical -set 126
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group3  -item {dut.d0.sum_scaled[0][10:0]} -position below

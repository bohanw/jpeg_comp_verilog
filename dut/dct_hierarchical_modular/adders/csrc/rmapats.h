...
extern "C" {
#endif
void  hsM_0_0__dve_daidir (UB  * pcode, scalar  val);
void  hsM_0_1__dve_daidir (UB  * pcode, scalar  val, U  I643, scalar  * I1111, U  did);
void  hsM_0_2__dve_daidir (UB  * pcode);
void  hsM_0_5__dve_daidir (UB  * pcode, UB  val);
void  hsM_3_0__dve_daidir (UB  * pcode, scalar  val);
void  hsM_4_0__dve_daidir (UB  * pcode, scalar  val);
void  hsM_4_1__dve_daidir (UB  * pcode, scalar  val, U  I643, scalar  * I1111, U  did);
void  hsM_4_2__dve_daidir (UB  * pcode);
void  hsM_5_0__dve_daidir (UB  * pcode, scalar  val);
void  hsM_5_1__dve_daidir (UB  * pcode, scalar  val, U  I643, scalar  * I1111, U  did);
void  hsM_5_2__dve_daidir (UB  * pcode);
void  hsM_6_0__dve_daidir (UB  * pcode, scalar  val);
void  hsM_6_1__dve_daidir (UB  * pcode, scalar  val, U  I643, scalar  * I1111, U  did);
void  hsM_6_2__dve_daidir (UB  * pcode);
void  hsM_6_11__dve_daidir (UB  * pcode, scalar  val);
void  hsM_8_0__dve_daidir (UB  * pcode, scalar  val);
void  hsM_8_1__dve_daidir (UB  * pcode, scalar  val, U  I643, scalar  * I1111, U  did);
void  hsM_8_2__dve_daidir (UB  * pcode);
void  hsM_8_5__dve_daidir (UB  * pcode, UB  val);
